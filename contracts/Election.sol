...
contract Election {
    ...
    constructor () public {
        addCandidate("Ram Das","Bharatiya Janata Party");
        addCandidate("Sankar Malakar","Indian National Congress");
        addCandidate("Suman Pathak","Communist Party Of India (Marxist)");
        addCandidate("Komola Nath","All India Trinamool Congress");
